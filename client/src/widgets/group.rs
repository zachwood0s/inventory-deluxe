use egui::{
    layers::ShapeIdx, Align, Frame, Id, InnerResponse, Response, Sense, Shape, Ui, UiBuilder,
...
pub struct Prepared {
    ...
    /// This is where we will insert  the frame shape so it ends up behind the ocntent.
...
impl Group {
    ...
    pub fn begin(self, ui: &mut Ui) -> Prepared {
        ...
        let content_ui = ui.new_child(builder);
